...
class Msa:
    def __init__(self, num_sequences: int, length: int, mask: List[bool]) -> None: ...
    def __init__(self, event_dict: Dict, root_sequence_length: int, root_node: node, save_list: List[bool]) -> None: ...
